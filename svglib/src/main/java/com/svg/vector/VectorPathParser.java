...
public class VectorPathParser {
    ...
    private static void addNode(ArrayList<PathDataNode> list, char cmd,
                                float[] val) {
        ...
        try {
            ...
            while (startPosition < totalLength) {
                ...
                if (startPosition < endPosition) {
                    results[count++] = Float.parseFloat(s.substring(
    ...
    public static class PathDataNode {
        ...
        public static void nodesToPath(PathDataNode[] node, Path path) {
            ...
            for (int i = 0; i < node.length; i++) {
                addCommand(path, current, previousCommand, node[i].type,
                        node[i].params);
            ...
            for (int k = 0; k < val.length; k += incr) {
                switch (cmd) {
                    ...
                    case 'T':
                        ...
                        break;
                    case 'a':
                        drawArc(path, currentX, currentY, val[k + 5] + currentX,
                                val[k + 6] + currentY, val[k], val[k + 1],
                        ...
                        break;
                    case 'A':
                        drawArc(path, currentX, currentY, val[k + 5], val[k + 6],
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a,
            ...
            for (int i = 0; i < numSegments; i++) {
                ...
                p.rCubicTo(delta_q1x, delta_q1y, delta_q2x, delta_q2y,
                        delta_e2x, delta_e2y);
