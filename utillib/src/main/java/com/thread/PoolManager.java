...
public class PoolManager {
    private static volatile ThreadPoolExecutor singleThread = new ThreadPool(1);
    private static volatile ThreadPoolExecutor shortTimeThread = new ThreadPool(Integer.MAX_VALUE);
    private static volatile ThreadPoolExecutor longTimeThread = new ThreadPool();
