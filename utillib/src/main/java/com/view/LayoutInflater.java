...
public abstract class LayoutInflater {
     ...
     *
     * @param newContext The new Context to associate with the new LayoutInflater. May
     ...
     *
     * @param filter The Filter which restricts the set of Views that are allowed
     ...
     * runtime.
     *
     * @param parser XML dom node containing the description of the view hierarchy.
     * @param root   Optional view to be the parent of the generated hierarchy.
     * @return The root View of the inflated hierarchy. If root was supplied,
     * this is the root View; otherwise it is the root of the inflated
     * XML file.
        ...
        try {
            ...
            InflateException ie = new InflateException(
                    attrs.getPositionDescription()
                            ...
                            + (constructor == null ? "<unknown>" : constructor
                            .getClass().getName()));
            ie.initCause(e);
            throw ie;
        }
    ...
    private void rInflate(XmlPullParser parser, View parent,
        ...
        try {
            ViewGroup.class.getDeclaredMethod("onFinishInflate").invoke(parent);
        } catch (Exception e) {
    ...
    private void parseInclude(XmlPullParser parser, View parent,
                              AttributeSet attrs) throws XmlPullParserException, Exception {
        int type;
            ...
            if (layout == 0) {
                ...
                try {
                    ...
                    if (TAG_MERGE.equals(childName)) {
                        ...
                        Class cl = null;
                        try {
                            cl = mContext.getClassLoader().loadClass("com.android.internal.R$styleable");
                        } catch (Exception e) {
                            // TODO: handle exception
                        }
                        TypedArray a = mContext.obtainStyledAttributes(attrs,
                                (int[]) cl.getField("View").get(null), 0, 0);
                        int id = a.getResourceId(
                                cl.getField("View_id").getInt(null),
                                View.NO_ID);
                        // While we're at it, let's try to override
                        // android:visibility. View_visibility
                        int visibility = a
                                .getInt(cl.getField("View_visibility").getInt(null),
                                        -1);
                        a.recycle();
