...
public class FileUtil {
    ...
    public static boolean isEmpty(File file) {
        ...
        if (file.isDirectory()) {
            if (NullUtil.isEmpty(file.listFiles())) {
    ...
    public static boolean insert(byte[] buff, File target, long startWith) {
        ...
        try {
            ...
            if (NullUtil.isEmpty(accessFile))
