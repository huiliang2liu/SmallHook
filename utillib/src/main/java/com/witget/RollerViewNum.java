...
public class RollerViewNum extends View {
    ...
    private int mColorLine = Color.rgb(0xee, 0xa9, 0x48);

    private int mViewHeight;
    private int mViewWidth;

    private float mLastDownY;
    private String text = "小时";
    /**
     * 滑动的距离
     */
    ...
    public RollerViewNum(Context context) {
        super(context);
        init();
    }

    public RollerViewNum(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    synchronized private void drawData(Canvas canvas) {
        ...
        canvas.drawText(text, mViewWidth * 0.5f + mMaxTextSize * 2, mViewHeight * 0.5f + mMaxTextSize * 0.4f,
                mPaint);
        ...
        float x = mViewWidth *.5f;
        float y = mViewHeight*.5f + mMoveLen;
