 ...
 **/
public interface Result extends com.result.activity.IResult, com.result.permission.IResult {
    /**
     * 2019/1/8 10:50
     * annotation：从相册中选择照片
     * author：liuhuiliang
    ...
    class Build {
        ...
        public Build(@NonNull android.support.v4.app.Fragment fragment) {
            result = new ResultImpl(fragment);
        }
